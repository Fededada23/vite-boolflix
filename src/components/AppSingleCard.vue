...
export default {
  ...
  methods: {
    //impostare il titolo della serie tv oppure del film
    title(value) {
    ...
    //impostare il titolo originale della serie tv oppure del film
    originalTitle(value) {
      if (value.media_type == 'tv') {
    ...
    //inserire il path dell'immagine di copertina
    posterImage(value) {
